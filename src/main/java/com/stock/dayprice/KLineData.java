...
import com.yilihjy.savesinastockdata.HistoryDataPOJO;
...
//    List<DataPo>
    public static List<DataPo> getDayKLineObjects(String url,String stock) throws java.text.ParseException {
        CloseableHttpClient httpclient = HttpClients.createDefault();
        String content="";
        content = getString(url, httpclient, content);
...
//        System.out.println(jsonArray);
        ...
        for (int i=0;i<length;i++){
            ...
            DataPo dataPo=new DataPo(stock, volume,  open,  high,  close,
                     low,  chg,  percent,  turnrate,
                     ma5,  ma10,  ma20,  ma30,
                     dif,  dea,  macd,
                     lot_volume,  timestamp,  TimeFormat.timeFormat(time));
            list.add(dataPo);
        }
